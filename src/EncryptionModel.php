...
class EncryptionModel extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'encipher:encryptionModel {model}';
     ...
     * @var string
     */
    protected $description = 'Encryption models rows';
    ...
    public function handle()
    {
        ...
        $this->attributes = $this->model->getEncipherAttributes();
