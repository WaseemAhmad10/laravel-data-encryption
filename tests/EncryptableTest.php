...
class EncipherTest extends TestCase {
    ...
    */
    public function it_test_that_encrypt_model_commands_encrypt_existing_records()
    {
        ...
        $this->artisan('encipher:encryptionModel', ['model' => TestUser::class]);
    ...
    */
    public function it_test_that_where_in_query_builder_is_working()
    {
        ...
        $this->createUser('Wasi Doe', $email);
    ...
    */
    public function it_test_that_decrypt_command_is_working()
    {
        ...
        $this->artisan('encipher:encryptionModel', ['model' => TestUser::class]);
        $this->artisan('encipher:decryptionModel', ['model' => TestUser::class]);
        $raw = DB::table('test_users')->select('*')->first();
    ...
    */
    ...
    {
        $email = 'Wasi@DOE.com';
        $user = $this->createUser('Wasi Doe', $email);
    ...
    */
    ...
    {
        $user = $this->createUser('Wasi Doe');

        $this->assertEquals($user->name, 'Wasi Doe');
        $this->assertEquals($user->toArray()['name'], 'Wasi Doe');
    }
}